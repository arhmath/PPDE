...
class RegistrasiApp:
    def __init__(self):
        ...
        self.age_var = tk.StringVar(value="18")  # Ubah ke StringVar untuk handling yang lebih baik
    ...
    def buat_interface(self):
        ...
        # Tambahkan validasi input untuk spinbox
        vcmd = (self.window.register(self.validate_age_input), '%P')
        ...
        # Hint untuk umur - PERBAIKI: Buat referensi age_hint
        ...
        # Simpan referensi spinbox untuk loading state
    ...
    def validate_age_input(self, value):
        """Validasi input untuk spinbox umur - hanya angka yang diperbolehkan"""
        if value == "":
            return True
        try:
            int(value)
    ...
    def validate_age(self):
        """Validasi umur dengan error handling yang diperbaiki"""
        try:
            age_str = self.age_var.get().strip()
            
            # Cek jika kosong
            if not age_str:
                self.set_validation_status('age', False, "Umur tidak boleh kosong")
                return False
            
            # Cek apakah bisa dikonversi ke integer
            age = int(age_str)
            ...
            self.set_validation_status('age', False, "Format umur tidak valid")
            return False
    ...
    def submit_form(self):
        ...
        try:
            ...
            user_data = {
                ...
                'email': self.email_var.get().strip(),
                'phone': self.phone_var.get().strip(),
                'age': int(self.age_var.get()),  # Konversi ke int untuk data final
    ...
    def show_loading(self):
        ...
        # Disable semua input
        for widget_name in ['nama_entry', 'email_entry', 'phone_entry', 'password_entry', 'confirm_password_entry', 'age_entry']:
